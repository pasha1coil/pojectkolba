...
<body>
	...
	<div>
		<center>
		<details>
		<summary class="floating-buttonSvod">Сводная таблица</summary>
				...
				<table id = "sf1" class="table custom-table">
				  <thead>
					<tr>  
					  ...
					  <th scope="col"><center>Должность</center></th>
    ...
    <div class="container">
        <h2 class="mb-5"><center>ОТЧЁТЫ</center></h2>
        ...
        <table id = "sf2" class="table custom-table">
          ...
          <tbody>
            <tr scope="row">
              ...
              <td><center>Преподаватель</center></td>
              <td>
                <center>ПИ</center>
              </td>
              <td><center>ИСИГТ</center></td>
              <td><center>321</center></td>
			  <td><center><a href="" class="floating-button">Скачать</a></center></td>
            </tr>
			...
			<tr scope="row">
              ...
              <td>
                <center>Торжков Сергей Валентинович</center>
              </td>
              <td><center>Декан</center></td>
              <td>
                <center>ФИЗ</center>
              </td>
              <td><center>ФСФ</center></td>
			...
			<tr scope="row">
              ...
              <td>
                <center>Томилова Екатерина Борисовна</center>
              </td>
              <td><center>Директор</center></td>
              <td>
                <center>ФГ</center>
              </td>
              <td><center>ФГМО</center></td>
