...
<!--===============================================================================================-->
  ...
  <body>
	...
	<div>
		<center>
		<details>
		<summary class="floating-buttonSvod">Понижающие показатели</summary>
		...
		<div class="content">
			...
			<div class="table-responsive custom-table-responsive">
				...
				<table id = "sf" class="table custom-table">
				  <thead>
					<tr>  
					  
					  <th scope="col"><center>ФИО</center></th>
					  <th scope="col"><center>Добавить Понижающие показатели</center></th>
					</tr>
				  </thead>
				  <tbody>
					<tr scope="row">
					  ...
					  <td>
						<center>Романов Николай Александрович</center>
					  </td>
					  <td><center><a href="страница понижающих показателей.html" class="floating-button">Добавить</a></center></td>
					</tr>
					<tr class="spacer"><td colspan="100"></td></tr>
					<tr scope="row">

					  <td>
						<center>Шевчук Александр Олегович</center>
					  </td>
					  <td><center><a href="страница понижающих показателей.html" class="floating-button">Добавить</a></center></td>
					</tr>
					<tr class="spacer"><td colspan="100"></td></tr>
        ...
        <div class="container">
            ...
            <div class="table-responsive custom-table-responsive">
                ...
                <table class="table custom-table">
                    ...
                    <td><center><input type="text" id="second1" oninput="mult(20,'second1','resultS1')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second1' id='resultS1'></label></center></td>
                    ...
                    <td><center><input type="text" id="second2" oninput="mult(40,'second2','resultS2')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second2' id='resultS2'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество человек"><input type="text" id="second3" oninput="mult(2,'second3','resultS3')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second3' id='resultS3'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество человек"><input type="text" id="second4" oninput="mult(1,'second4','resultS4')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second4' id='resultS4'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество человек"><input type="text" id="second5" oninput="mult(2,'second5','resultS5')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second5' id='resultS5'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second6" oninput="mult(1,'second6','resultS6')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second6' id='resultS6'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second7" oninput="mult(0.5,'second7','resultS7')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second7' id='resultS7'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second8" oninput="mult(0.2,'second8','resultS8')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second8' id='resultS8'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center><input type="text" id="second9" oninput="mult(5,'second9','resultS9')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second9' id='resultS9'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center><input type="text" id="second10" oninput="mult(2,'second10','resultS10')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second10' id='resultS10'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center><input type="text" id="second11" oninput="mult(3,'second11','resultS11')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second11' id='resultS11'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second12" oninput="mult(0.4,'second12','resultS12')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second12' id='resultS12'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second13" oninput="mult(0.3,'second13','resultS13')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second13' id='resultS13'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second14" oninput="mult(0.2,'second14','resultS14')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second14' id='resultS14'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Сколько процентов?"><input type="text" id="second15" oninput="mult(0,'second15','resultS15')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second15' id='resultS15'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Сколько процентов?"><input type="text" id="second16" oninput="mult(0,'second16','resultS16')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second16' id='resultS16'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Сколько процентов?"><input type="text" id="second17" oninput="mult(0,'second17','resultS17')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second17' id='resultS17'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second18" oninput="mult(0.5,'second18','resultS18')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second18' id='resultS18'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second19" oninput="mult(0.1,'second19','resultS19')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second19' id='resultS19'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second20" oninput="mult(15,'second20','resultS20')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second20' id='resultS20'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second21" oninput="mult(5,'second21','resultS21')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second21' id='resultS21'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second22" oninput="mult(1,'second22','resultS22')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second22' id='resultS22'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second23" oninput="mult(1,'second23','resultS23')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second23' id='resultS23'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second24" oninput="mult(1,'second24','resultS24')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second24' id='resultS24'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second25" oninput="mult(0.5,'second25','resultS25')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second25' id='resultS25'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="h-index"><input type="text" id="second26" oninput="mult(1,'second26','resultS26')" size="5" placeholder="__________"></td>
                    <td><center><label for='second26' id='resultS26'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество баллов РИНЦ"><input type="text" id="second27" oninput="mult(0.1,'second27','resultS27')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second27' id='resultS27'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество отзывов"><input type="text" id="second28" oninput="mult(0.5,'second28','resultS28')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second28' id='resultS28'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество отзывов"><input type="text" id="second29" oninput="mult(0.2,'second29','resultS29')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second29' id='resultS29'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second30" oninput="mult(5,'second30','resultS30')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second30' id='resultS30'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second31" oninput="mult(3,'second31','resultS31')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second31' id='resultS31'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second32" oninput="mult(0.2,'second32','resultS32')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second32' id='resultS32'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second33" oninput="mult(0.4,'second33','resultS33')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second33' id='resultS33'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second34" oninput="mult(0.3,'second34','resultS34')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second34' id='resultS34'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="second35" oninput="mult(0.2,'second35','resultS35')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second35' id='resultS35'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество рублей"><input type="text" id="second36" oninput="mult(2,'second36','resultS36')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second36' id='resultS36'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество рублей"><input type="text" id="second37" oninput="mult(2,'second37','resultS37')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second37' id='resultS37'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <tr scope="row">
                    ...
                    <td><center><input type="text" id="second38" oninput="mult(4,'second38','resultS38')" size="5" placeholder="__________"></td>
                    <td><center><label for='second38' id='resultS38'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Факт"><input type="text" id="second39" oninput="mult(0.2,'second39','resultS39')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second39' id='resultS39'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Факт"><input type="text" id="second40" oninput="mult(0.2,'second40','resultS40')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='second40' id='resultS40'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files2[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество процентов"><input type="text" id="three1" oninput="mult(2,'three1','resultt1')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three1' id='resultt1'></label></center></td>
                    ...
                    <td><center data-tooltip="Количество процентов"><input type="text" id="three2" oninput="mult(2.5,'three2','resultt2')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three2' id='resultt2'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество процентов"><input type="text" id="three3" oninput="mult(3,'three3','resultt3')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three3' id='resultt3'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <table class="table custom-table">
                    ...
                    <td><center data-tooltip="Количество процентов"><input type="text" id="three4" oninput="mult(2,'three4','resultt4')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three4' id='resultt4'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество процентов"><input type="text" id="three5" oninput="mult(3,'three5','resultt5')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three5' id='resultt5'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество процентов"><input type="text" id="three6" oninput="mult(4,'three6','resultt6')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three6' id='resultt6'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                </table>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Номер группы"><input type="text" id="three7" oninput="mult(2,'three7','resultt7')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three7' id='resultt7'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Название команды"><input type="text" id="three8" oninput="mult(5,'three8','resultt8')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three8' id='resultt8'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                ...
                <table class="table custom-table">
                    ...
                    <td><center><input type="text" id="three9" oninput="mult(10,'three9','resultt9')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three9' id='resultt9'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center><input type="text" id="three10" oninput="mult(7,'three10','resultt10')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three10' id='resultt10'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr scope="row">
                    ...
                    <td><center><input type="text" id="three11" oninput="mult(4,'three11','resultt11')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three11' id='resultt11'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    </tr>
                ...
                <tr scope="row">
                    ...
                    <td><center data-tooltip="Количество штук"><input type="text" id="three12" oninput="mult(4,'three12','resultt12')" size="5" placeholder="__________"></center></td>
                    <td><center><label for='three12' id='resultt12'></label></center></td>
                    <td><center><fieldset align = "right"><p><input type="file" name="files3[]"></p></fieldset></center></td>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                    <tr class="spacer"><td colspan="100"></td></tr>
                ...
                <tr scope="row">
                    ...
                    <td><center><output name="result"><h2>0</h2></output></center></td>
